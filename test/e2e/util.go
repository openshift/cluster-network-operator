...
func init() {
	...
	// Set up the OpenShift test environment by calling WithCleanup with a no-op function
	// This initializes the testsStarted flag required by OpenShift test utilities
...
func curlPod2PodPass(oc *exutil.CLI, namespaceSrc string, podNameSrc string, namespaceDst string, podNameDst string, podPort int) {
...
func curlPod2SvcPass(oc *exutil.CLI, namespaceSrc string, namespaceSvc string, podNameSrc string, svcName string, svcPort int) {
...
func createPingPodOnNode(oc *exutil.CLI, podName, namespace, label, nodeName string) {
...
func createGenericService(oc *exutil.CLI, serviceName, namespace, protocol, selector, serviceType, ipFamilyPolicy, internalTrafficPolicy, externalTrafficPolicy string, servicePort, serviceTargetPort int) {

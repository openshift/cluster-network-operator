...
script to `kubectl create namespace openshift-ovn-kubernetes` and then to create a configMap using the example found [here](./gateway-mode.yaml).
Do this as a step right after the cluster-config-v1 configMap is created.

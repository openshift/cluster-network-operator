...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultusCNIConfig) DeepCopyInto(out *MultusCNIConfig) {
	*out = *in
	if in.Delegates != nil {
		in, out := &in.Delegates, &out.Delegates
		*out = make([]*MultusDelegate, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MultusDelegate)
				**out = **in
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultusCNIConfig.
func (in *MultusCNIConfig) DeepCopy() *MultusCNIConfig {
	if in == nil {
		return nil
	}
	out := new(MultusCNIConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultusDelegate) DeepCopyInto(out *MultusDelegate) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultusDelegate.
func (in *MultusDelegate) DeepCopy() *MultusDelegate {
	if in == nil {
		return nil
	}
	out := new(MultusDelegate)

...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(source.Kind[crclient.Object](mgr.GetCache(), &configv1.Network{}, &handler.EnqueueRequestForObject{}, predicate.GenerationChangedPredicate{}))
	if err != nil {
		return err
	}
...
func (r *ReconcileClusterConfig) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if err := network.ValidateClusterConfig(clusterConfig, r.client, r.featureGates); err != nil {
		...
		r.status.MaybeSetDegraded(statusmanager.ClusterConfig, "InvalidClusterConfig",

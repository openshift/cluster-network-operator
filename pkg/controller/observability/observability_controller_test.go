...
func TestWaitForOperator_MissingStatus(t *testing.T) {
	...
	// Create ClusterExtension without status.conditions
	...
	clusterExtension.SetName("netobserv-operator")
	// Do not set status.conditions - this tests the missing status path

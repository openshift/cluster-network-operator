...
func (r *ReconcileProxyConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// A nil proxy is generated by installs and not requiring a proxy
	// and upgrades to 4.2, skip reconciliation.
	if len(proxyConfig.Spec.HTTPProxy) == 0 && len(proxyConfig.Spec.HTTPSProxy) == 0 {

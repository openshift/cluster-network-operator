...
func Render(conf *operv1.NetworkSpec, bootstrapResult *bootstrap.BootstrapResult, manifestDir string, client cnoclient.Client, hostMTU int) ([]*uns.Unstructured, bool, error) {
	...
	o, progressing, err = renderDefaultNetwork(conf, bootstrapResult, manifestDir, client, hostMTU)
	if err != nil {
		return nil, progressing, err
	}
	objs = append(objs, o...)
...
func renderDefaultNetwork(conf *operv1.NetworkSpec, bootstrapResult *bootstrap.BootstrapResult, manifestDir string,
	...
	case operv1.NetworkTypeOVNKubernetes:
		return renderOVNKubernetes(conf, bootstrapResult, manifestDir, client, hostMTU)
	case operv1.NetworkTypeKuryr:

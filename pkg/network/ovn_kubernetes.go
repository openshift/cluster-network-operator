...
func shouldRenderIPsec(conf *operv1.OVNKubernetesConfig, bootstrapResult *bootstrap.BootstrapResult) (renderCNOIPsecMachineConfig, renderIPsecDaemonSet,
	...
	//     path for this upgrade scenario which also avoids the deployment to
	//     fail because libreswan is not installed on the host yet.
	...
	//     be installed from 4.14 MCP which is having all known stability
	//     problems.

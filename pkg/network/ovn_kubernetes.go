...
// shouldRenderIPsec method ensures the have following IPsec states for upgrade path from 4.14 to 4.15:
...
// IPsec MachineConfig and render ipsec-host daemonset. Until IPsec MachineConfig rolled out on the node, it uses ovn-ipsec-containerized
// daemonset pod to configure IPsec on the node.
...
// In case of upgrades after 4.15, it updates both ipsec-host daemonset and IPsec Machine Config to the newer version.
// For Hypershift cluster, it updates ovn-ipsec-containerized daemonset to newer version.

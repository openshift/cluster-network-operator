...
replace github.com/openshift/api => github.com/ricky-rav/api v0.0.0-20260225144623-70eb49a1cefd

replace github.com/openshift/client-go => github.com/ricky-rav/client-go v0.0.0-20260227114734-e5e8f8ec4593

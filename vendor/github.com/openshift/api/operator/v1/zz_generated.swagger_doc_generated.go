...
var map_OVNKubernetesConfig = map[string]string{
	...
	"noOverlayConfig":     "noOverlayConfig contains configuration for no-overlay mode. This configuration applies to the default (primary) network only. It is required when transport is \"NoOverlay\". When omitted, this means the user does not configure no-overlay mode options.",

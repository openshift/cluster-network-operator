...
type IPsecConfig struct {
	...
	// Valid values are `Disabled`, `External`, `Full` and omitted.
	...
	// When omitted, this means no opinion and the platform is left to choose a reasonable default which is
	// subject to change over time.
	// The current default behaviour is `Full`.

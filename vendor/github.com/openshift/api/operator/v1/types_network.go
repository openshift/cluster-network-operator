...
// +openshift:validation:FeatureGateAwareXValidation:featureGate=NoOverlayMode,rule="has(oldSelf.transport) || !has(self.transport)",message="transport can only be set at installation time"

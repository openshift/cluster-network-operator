...
type OVNKubernetesConfig struct {
	...
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="DefaultNetworkTransport field is immutable"
	// +optional
	...
	// +openshift:enable:FeatureGate=NoOverlayMode
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="defaultNetworkNoOverlayOptions field is immutable"
	// +optional

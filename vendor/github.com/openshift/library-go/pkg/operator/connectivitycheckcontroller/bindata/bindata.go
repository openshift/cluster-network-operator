...
var _pkgOperatorConnectivitycheckcontrollerManifestsControlplaneOperatorOpenshiftIo_podnetworkconnectivitychecksYaml = []byte(`apiVersion: apiextensions.k8s.io/v1beta1
